...
adminDashboard.controller("addCourseController", function($scope, $http, $cookies) {
	...
	$http({
		...
		url : 'https://localhost:8443/StudentCourseRegistrationSystem/rest/schedules'
	...
	$http({
		...
		//url : 'https://localhost:8080/StudentCourseRegistrationSystem/rest/curriculum'
			url : 'https://localhost:8443/StudentCourseRegistrationSystem/rest/curriculum'
	}).success(function(data, status, headers,config) {
	...
	$http({
		...
		//url : 'https://localhost:8080/StudentCourseRegistrationSystem/rest/books'
			url : 'https://localhost:8443/StudentCourseRegistrationSystem/rest/books'
	}).success(function(data, status, headers,config) {
												 $scope.books = data;
											}).error(
												function(data, status, headers,
...
adminDashboard.controller("disableCourseController", function($scope, $http) {
	...
	$http({
		...
		url : 'https://localhost:8443/StudentCourseRegistrationSystem/rest/courses/'+courseId
	 }).success(function(data, status, headers, config) {
		 $scope.message = data;
		 $scope.status = status;
...
adminDashboard.controller("deleteStudentController", function($scope, $http, $cookies) {
	...
	$scope.deleteStudent = function(studentId){
		$http({
			...
			url : 'https://localhost:8443/StudentCourseRegistrationSystem/rest/students/'+studentId
		 }).success(function(data, status, headers, config) {
