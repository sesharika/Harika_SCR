var addCourseApp = angular.module("addCourseApp",['angularjs-dropdown-multiselect','ui']);

addCourseApp.controller("addCourseController", function($scope, $http) {
	
	$http({
		method : 'GET',
		url : 'http://localhost:8080/StudentCourseRegistrationSystem/rest/schedules'
	...
	$http({
		method : 'GET',
		url : 'http://localhost:8080/StudentCourseRegistrationSystem/rest/curriculum'
	}).success(function(data, status, headers,config) {
	...
	$http({
		method : 'GET',
		url : 'http://localhost:8080/StudentCourseRegistrationSystem/rest/books'
	}).success(function(data, status, headers,config) {
												 $scope.books = data;
											}).error(
												function(data, status, headers,
